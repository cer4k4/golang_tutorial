...
func main() {
	...
	cartUsecase := usecase.NewCartUseCase(cartRepo, orderRepo, productRepo, userRepo)
	paymentUsecase := usecase.NewPaymentUseCase(paymentRepo, cartRepo, orderRepo, productRepo, userRepo)
